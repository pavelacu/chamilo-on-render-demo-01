...
$TemplateCertificateComment = "Primer oblike potrdila";
$TemplateCertificateTitle = "Potrdilo";
$ResultsVisibility = "Vidnost rezultatov";
$DownloadCertificate = "Prenesi potrdilo";
...
$ForumContent = "Forum je asinhrono avtorsko razpravljalno orodje pisnih del oz. izdelkov. Za razliko od elektronske pošte je forum
namenjen javni, pol-javni razpravi na določeno temo, ali pa je omejen na izbrano skupino razpravljalcev.<p/>
...
$DisplayCertificate = "Prikaži potrdilo";
$Doc = "Tečaj";
...
$YourGradebookFirstNeedsACertificateInOrderToBeLinkedToASkill = "Potrdilo redovalnice je potrebno, če želite redovalnico povezati s spretnostmi";
...
$CertificateMinScore = "Minimalen rezultat za pridobitev potrdila";
...
$GradebookSkillsRanking = "Ocena";
$SaveScoringRules = "Shrani pravila ocenjevanja";
$AttachCertificate = "Pripni potrdilo";
$GradebookSeeListOfStudentsCertificates = "Poglej seznam pridobljenih potrdil";
$CreateCertificate = "Ustvari potrdilo";
$UploadCertificate = "Naloži potrdilo";
$CertificateName = "Naziv potrdila";
$CertificateOverview = "Pregled potrdil";
$CreateCertificateWithTags = "Ustvari potrdilo s to oznako";
...
$NoCertificateAvailable = "Nobenega potrdila ni na voljo";
$SaveCertificate = "Shrani potrdilo";
$CertificateNotRemoved = "Potrdila ni možno odstraniti";
$CertificateRemoved = "Potrdilo je bilo odstranjeno";
$NoDefaultCertificate = "Ni privzet";
$DefaultCertificate = "Privzeto potrdilo";
$PreviewCertificate = "Predogled potrdila";
$IsDefaultCertificate = "Potrdilo je nastavljeno kot privzeto";
$ImportPresences = "Uvozi prisotnost/prisotne";
$AddPresences = "Dodaj prisotnost/prisotne";
$DeletePresences = "Odstrani prisotnost";
$GradebookListOfStudentsCertificates = "Seznam potrdil tečajnikov iz redovalnice";
...
$ThereIsNotACertificateAvailableByDefault = "Nobeno privzeto potrdilo ni na voljo";
$CertificateMinimunScoreIsRequiredAndMustNotBeMoreThan = "Minimalen rezultat za doseganje potrdila je zahtevan in ne sme biti več kot";
...
$TemplateTitleCertificate = "Potrdilo ob zaključku";
...
$CertificateGenerated = "Generirano potrdilo";
...
$GenerateCertificates = "Generiraj potrdila";
$ExportAllCertificatesToPDF = "Izvozi vsa potrdila v PDF";
$DeleteAllCertificates = "Odstrani vsa potrdila";
$QuarterlyReport = "Četrtletno poročilo";
...
$HelpFolderCertificates = "INFORMACIJA VIDNA ZGOLJ UČITELJEM:\nTa mapa vsebuje različne predloge potrdil, ki se izdajajo kot rezultat uspešnosti izvedbe (dela) učnega procesa.Ni priporočljivo, da to mapo naredite vidno vsem uporabnikom.";
$DestinationDirectory = "Ciljna mapa";
$CertificatesFiles = "Potrdila";
...
$CertificateOnlineLink = "Povezava na potrdilo";
...
$AllowPublicCertificatesTitle = "Dovoli javna potrdila";
$AllowPublicCertificatesComment = "Uporabniška potrdila so vidna tudi neregistriranim uporabnikom.";
...
$NoStudentCertificatesAvailableYet = "Trenutno ni na voljo nobeno potrdilo tečajnikov. Pomnite, da mora tečajnik za generiranje potrdila dostopiti do orodja Naloge in klikniti na ikono potrdila. Ikona je dostopna zgolj v primeru, da je tečajnik izpolnil kriterije za doseganje potrdila";
$CertificateExistsButNotPublic = "Zahtevano potrdilo obstaja, vendar ni javno. Prijavite se, če si ga želite ogledati.";
$Default = "Privzeto";
...
$AllowPublicCertificates = "Tečajnikova potrdila so javna";
...
$YouNotYetAchievedCertificates = "Trenutno še niste pridobili nobenega potrdila. Nadaljujte z izvajanjem učne poti za njegovo pridobitev.";
$SearchCertificates = "Poišči potrdila";
$TheUserXNotYetAchievedCertificates = "Tečajnik %s še ni pridobil nobenega potrdila";
...
$FilterCertificateByOfficialCodeTitle = "Potrdila filtrirana po uradni kodi";
$FilterCertificateByOfficialCodeComment = "Dodaj filter glede tečajnikove uradne kode v seznamu potrdil";
...
$CertificateHideExportLinkStudentTitle = "Potrdila: skrij povezavo za izvoz pred tečajniki";
$CertificateHideExportLinkStudentComment = "V primeru, da je možnost omogočena, tečajniki ne morejo izvoziti svojih potrdil v PDF. Možnost je na voljo, ker je kvaliteta izvoza močno odvisna od natančne HTML strukture predloge potrdila. V primeru slabe kvalitete je bolje ne dopustiti uporabe takega certifikata.";
$CertificateHideExportLinkTitle = "Potrdila : skrij povezavo do izvoza v PDF";
$CertificateHideExportLinkComment = "Omogoči popolno odstranitev možnosti za izvoz potrdil v PDF (za vse uporabnike). Če je možnost omogočena, vključuje skrivanje izvoza pred tečajniki.";
...
$DownloadCertificatePdf = "Prenesi potrdilo v obliki PDF";
...
$NowDownloadYourCertificateClickHere = "Svoje potrdilo lahko prenesete s klikom tule";
...
$AreYouSureYouWantToUnassignTheTicket = "Resnično želite preklicati dodelitev zahtevka?";
...
$UploadCorrectionsExplanationWithDownloadLinkX = "Najprej prenesite popravke od <a href=\"%s\">tule</a> . Nato razpakirajte datoteke, ne da bi spreminjali njihova imena. Izvedite spremembe, nato ustvarite zip datoteko iz spremenjenih ter jo naložite preko te forme.";
$PostsPendingModeration = "Objava čaka moderacijo";
$OnlyUsersFromCourseSession = "Zgolj uporabniki iz enega tečaja seje";
$ServerXForwardedForInfo = "Če se strežnik nahaja za proxy strežnikom ali za požarnim zidom (in zgolj v teh primerih), bo včasih potrebno uporabiti X_FORWARDED_FOR HTTP za identifikacijo originalnega IP naslova strežnika (v tem primeru vašega).";
...
$StudentCourseCertificateX = "Potrdilo: %s";
$ConfigureExerciseVisibilityInCourseTitle = "Omogoči preglasitev nastavitve vidnosti za vaje/teste iz nastavitev baznega tečaja v seji tečaja.";
$ConfigureExerciseVisibilityInCourseComment = "Omogoči nastavitev vidnosti vaj/testov znotraj seje tečaja s preglasitvijo globalne nastavitve v baznem tečaju. Če ni nastavljena, se za vidnost uporabijo globalne nastavitve.";
...
$ScheduledAnnouncements = "Časovno razporejena obvestila";
$SpecificDate = "Dostava na določen datum";
$BaseDate = "Dostava na datum začetka/konca seje";
$AfterOrBefore = "Po ali pred";
$Before = "Pred";
$ScheduleAnnouncementDescription = "Obrazec omogoča avtomatsko časovno razporejanje pošiljanja sporočil uporabnikom tečaja v seji. Definirana sta dva načina: pošiljanje na specifičen, vnaprej določen datum, in pošiljanje ob začetku oz. zaključku seje. V slednjem je potrebno podati koliko dni pred začetkom seje se obvestilo odpošlje oz. koliko dni po zaključku tečaja v seji se to zgodi.";
...
$NotificationCertificateSubject = "Obvestilu ob prejemu potrdila";
...
$SendCertificateNotifications = "Pošlji obvestila o potrdilih vsem uporabnikom";
...
$AgendaAvailableInCourseX = "Agenda je na voljo v tečaju %s";
...
$EnableAddCloudFileLinkTitle = "Omogoči dodajanje povezave na oblak";
...
$MyGeneralCertificate = "Moje globalno potrdilo";
$ScoreNote = "Beležka";
$ScoreTest = "Test";
...
$QuestionDegreeCertaintyHTMLMail = "Podrobnosti rezultatov testa %s boste našli spodaj.<br />
Za vpogled v podrobnosti teh rezultatov:
<br /><br />
1. Prijavite se v platformo (uporabniško ime/geslo): <a href='%s'>K platformi</a>.
<br /><br />
2. Kliknite to povezavo: <a href='%s'>Poglej podrobnosti rezultatov</a>.";
...
$IfYouWantToGetTheCertificateAndOrSkillsAsociatedToThisCourseYouNeedToBuyTheCertificateServiceYouCanGoToServiceCatalogClickingHere = "Če želite prejeti potrdilo in/ali kvalifikacije, kompetence, veščine  povezane s tem tečajem, morate kupiti storitev potrdil/potrjevanja. S klikom na to povezavo lahko odprete katalog storitev: %s";
...
$FrmReadOutTextIntro = "Pripeti morate zvočno datoteko skladno z besedilom: kliknite na %s ikono.";
$CreateReadOutText = "Ustvarite bralno besedilo";
...
$LpMinTime = "Minimalen čas (minute)";
...
$BasicCourseDocuments = "Dokumenti baznega/izhodiščnega tečaja";
$WeekX = "Teden %s";
...
$ResumeImport = "Nadaljuj z uvozom";
$Candidate = "Kandidat";
$Domains = "Domene";
...
$RealisationCertificate = "Potrdilo dosežka";
...
$LearnpathUseScoreAsProgressComment = "Uporabi rezultat vrnjen iz edinega SCO v tej učni poti kot indikator napredka. Izbira spremeni obnašanje SCORM v smislu točnosti, vendar pa izboljša vizualno povratno infomacijo učečemu.";
$Planned = "Planirano";
...
$UseLearnpathScoreAsProgressInfo = "Nekatere SCORM učne poti, še posebej tiste z eno samo SCO, lahko vračajo napredek v poti kot rezultat SCO (cmi.core.score.raw). Z izbiro te opcije (dostopna je zgolj v učnih potem z eno samo SCO), bo Chamillo prikazoval rezultat iz elementa SCO kot napredek. Pazite pa, s tem sočasno izgubite možnost, da dobite kakršenkoli pravi rezultat iz tega elementa!";
...
$CertificateOfAchievement = "Potrdilo dosežka";
$CertificateOfAchievementByDay = "Potrdilo dosežkov za dan";
...
$SessionsPerCategory = "Sej na kategorijo";
...
$SubscriptionCount = "Število prijav";
$VoteCount = "Število glasov";
$ExportAsCompactCSV = "Izvozi kot kompakten CSV";
$SendToGroupTutors = "Objavi za tutorje skupin";
$GroupSurveyX = "Vprašalnik skupine za %s";
$HelloXGroupX = "Pozdravljen %s<br /><br />
Kot tutor skupine %s si povabljen k sodelovanju z izpolnitvijo naslednjega vprašalnika:";
$SurveyXMultiplicated = "Vprašalnik %s je multipliciran";
$SurveyXNotMultiplicated = "Vprašalnik %s ni multipliciran";
...
$SurveyQuestionMultipleChoiceWithOther = "Večkratna izbira s prostim besedilom";
...
$Multiplechoiceother = "Večkratna izbira z opcijo 'drugo'";
...
$CertificatesSessions = "Potrdila v sejah";
...
$AddImageWithZoom = "Dodaj sliko s povečavo";
...
$UsersByTargetLanguage = "Uporabniki po izbranem jeziku";
$UsersByContract = "Uporabniki po kontaktu";
$UsersByCertificate = "Uporabniki po potrdilih";
...
$CourseCodeConfirmation = "Potrditev kode tečaja";
$UnsupportedQtiVersion = "Nepodprta IMS/QTI različica.";
$ExportAllCertificatesToZIP = "Izvozi vsa potrdila v ZIP datoteko.";
$CurrentScore = "Trenutni dosežek";
$AddAttempt = "Dodaj poskus";
$SurveysWordInASCII = "vprašalnik";
$PrivateBetweenUsers = "Privatno med uporabniki";
$Nothing = "Nič";
$CompilatioAnalysisInProgress = "Izvajanje analize Compilatio ...v teku...";
$AccountExpiration = "Potek računa";
...
$DaysDifference = "Razlika v dnevih";
...
$YouPassedTheLimitOfXMinutesToSeeTheResults = "Presegli ste %s minutno omejitev za ogled rezultatov.";
$LastUpdated = "Nazadnje ažurirano";
$Age = "Starost";
$ExportToXls = "Izvozi v XLS";
$CourseLearningPathsGenericStats = "Učne poti - splošna statistika";
...
$TimeSpentOnAssignment = "Čas porabljen za nalogo";
$UserXSignedTheAgreementTheDateY = "Uporabnik %s je podpisal soglasje na %s";
$Available = "Na voljo";
$SurveyMultipleChoiceWithOther = "Večkratna izbira z možnostjo 'drugo'";
$CompilatioDescription = "
Compilatio anti-plagiatorski modul";
$CompilatioQuota = "Kvote";
$CompilatioCreditXOnY = "Krediti: %s od %s";
...
$NoEntity = "Ni organizacij";
$UserByEntityReport = "Uporabniki po organizaciji";
$LpByAuthor = "Učne poti po avtorju";
$SessionImportAssignments = "Uvozi naloge iz baznega tečaja";
...
$SubscribeClassesToLpCategory = "Vpiši razrede k kategoriji";
$ResultsOnlyAvailableOnline = "Rezultati so dostopni zgolj na spletu (online)";
$QuestionStats = "Statistika vprašanj";
$WrongAnswer = "Napačen odgovor";
$WrongAttemptXInCourseX = "Neuspeh v poskusu %s dne %s";
...
$MyPersonalOpenAreaHelp = "Vaša kratka predstavitev, profesionalne in/ali osebne izkušnje ter prepričanja.";
$MyCompetencesHelp = "Kompetence, ki ste jih pridobili (zbrali), formalno ali neformalno pridobljene, socialne ali tehnične.";
$UserGuides = "Uporabniški priročniki";
...
$ContentList = "Seznam vsebin";
$Tariff = "Tarifa";
$ToInvoice = "K naročilu";
$LearningPathItemByAuthor = "Elementi učnih poti po avtorjih";
$DeleteExerciseAttempts = "Odstrani tudi vse poskuse izvedb vaje/testa. Če možnost ni izbrana, bodo rezultati odstranjene vaje/testa še vedno na voljo.";
$ExerciseCategoriesRadarMode = "Prikaži zgolj graf radarja po kategorijah namesto tabele kategorij. Ne prikaži posameznih rezultatov niti povratne informacije.";
$ExerciseBlockBecausePercentageX = "Vsi poskusi so onemogočeni ker niste uspeli doseči minimalnega rezultata %s %% v enem izmed vaših predhodnih poskusov.";
$RegisteredAuthors = "Registrirani avtorji";
$Price = "Cena";
$PriceUpdated = "Cena je bila ažurirana";
$RemoveSelected = "Odstrani izbrane avtorje";
$DeletedAuthors = "Avtorji so bile odstranjeni";
$XQuestionsSelectedWithTotalScoreY = "Zgolj %d vprašanj bo izbrano glede na nastavitev testa, za skupni možni rezultat %s.";
...
$IfYourQuizHaveHotspotQuestionsIncludedYouShouldSelectTheImagesFromTheDocuments = "V primeru, da vaš test vsebuje nalogo z vročo točko, morate iz izbrati tudi vse pripadajoče slike iz dokumentov.";
$BackToAttemptList = "Nazaj na seznam poskusov";
$ShowScoreEveryAttemptShowAnswersLastAttemptNoFeedback = "Prikaže rezultate učečim: prikaže rezultat, tečajnikovo izbiro in njegovo povratno informacijo za vsak poskus, pravilen odgovor in povratno informacijo, kadar je dosežena izbrana omejitev števila izvajanj.";
$AddGradebookComment = "Komentar";
$LatestLoginInAnyCourse = "Zadnja prijava v tečaj";
$QuestionForNextUser = "Vprašanja o naslednjem uporabniku";
$CourseCodeToEnteredCapitalLettersToConfirmDeletionX = "Za potrditev odstranitve tačaja morate nejgovo kodo vnesti z velikimi črkami: %s";
$BadgeXTitle = "Značka: %s";
$PortfolioCommentFromXUser = "Komentar s strani %s";
$PortfolioItemFromXUser = "Element portfelja '%s'";
$CopyToMyPortfolio = "Kopiraj v moj portfelj";
$CopyToStudentPortfolio = "Kopiraj v tečajnikov portfelj";
$OriginallyPublishedAsXTitleByYUser = "Izvorno objavljeno kot \"%s\" s strani %s";
$OriginallyCommentedByXUserInYItem = "Izvorno komentirano s strani %s v \"%s\"";
$PortfolioItemAddedToStudents = "Element je bil dodan v lasten portfelj učečega";
$MarkCommentAsImportant = "Označi komentar kot pomemben";
$UnmarkCommentAsImportant = "Razveljavi pomembnost komentarja";
$CommentMarkedAsImportant = "Element portfelja je označen kot pomemben";
$SelectLearnerPortfolio = "Izberi portfelj učečega";
$SeeMyPortfolio = "Poglej moj portfelj v tem tečaju";
...
$HideCorrectAnsweredQuestions = "Skrij vprašanja s pravilnimi odgovori";
$TheSettingXWillChangeToX = "Nastavitev \"%s\" se bo spremenila v \"%s\"";
$VerificationOfAnsweredQuestions = "Preverjanje odgovorov na vprašanja";
$StudentPublicationToCorrect = "Zadolžitve tečajnikov za popravo";
$StudentPublicationCorrectionWarning = "Spodaj najdete vse izdelke, ki so bili poslani s strani tečajnikov v enem izmed vaših tečajev (v izvornem tečaju ali tečaju seje). Seznam lahko filtrirate z izbiro specifičnega tečaja ali po trenutnem statusu.";
$BackToMainPortfolio = "Nazaj na izhodiščni portfelj tečaja";
$ExportMyPortfolioDataPdf = "Izvozi moj portfelj v PDF datoteko";
$ExportMyPortfolioDataZip = "Izvozi moj portfelj kot ZIP datoteko";
$PortfolioCategoryFieldHelp = "Kategorije služijo organizaciji zgolj v osebnem portfelju.";
...
$XPercentCompleted = "%s %% dokončanega";
$EmailToTeachersWhenNewPost = "Pošlji e-poštno sporočilo učitelju ob objavi novega elementa v orodju portfelja";
$PortfolioAlertNewPostContent = "Objava avtorja %s je novo-objavljena v portfelju tečaja %s. Za vpogled <a href='%s'>kliknite tule</a>";
$PortfolioAlertNewPostSubject = "[Portfelj] Nova objava v tečaju %s";
$OngoingTraining = "Učni proces/trening v izvajanju";
$QuizRemindSubject = "Imate novo sporočilo osebe %s";
$QuizFirstRemindBody = "Pozdravljen $s,<br /><br />
nova vaja/test je bila dodana v tečaj %s.<br /><br />
Tečaj: %s<br />
Vaja/test : %s<br />";
$QuizLastRemindBody = "Obišči vajo/test %s";
$QuizDhrRemindBody = "Pozdravljen $s,<br /><br />
kot starša vas obveščamo, da je %s prejel novo vajo/test %s v tečaj %s.<br /><br />
Učeči: %s<br />
Tečaj: %s<br />
Vaja/test : %s<br />";
...
$ScormAndLPMaxProgress = "Največji napredek v učnih poteh";
$HideSkills = "Skrij veščine";
$HideAssignment = "Skrij zadolžitve";
$AddSurveyToCourse = "Dodaj vprašalnik tečaju";
...
$FilterByLp = "Filtriraj po učni poti";
...
$YourLpResultsAre = "Dosegli ste naslednje rezultate v učnih poteh:";
$YourLpQuizzesResultsAre = "Dosegli ste naslednje rezultate v testih:";
...
$SkillMinScore = "Minimalen rezultat";
$InLp = "V učni poti";
...
$SeeForTablet = "Pogled za tablico";
...
$FilterByClass = "Filter po razredu";
$NotInAnyClass = "Ni v nobenem razredu";
$XAccountDisabledByYAttempts = "Uporabniški račun %s je bil onemogočen po %d neuspešnih poskusih prijave.";
$AnswerList = "Seznam odgovorov";
$EnterListOfAnswersOneAnswerByLine = "Vnesite seznam odgovorov (en odgovor na vrstico)";
$OrSelectCsvFileWithListOfAnswers = "Ali izberi CSV datoteko s seznamom odgovorov";
$ConvertToMultipleAnswerDropdown = "Pretvori v večkraten odgovor s padajočo izbiro";
$MultipleAnswerDropdown = "Večkraten odgovor s padajočo izbiro";
$Highlighted = "Poudarjeno";
$SeeHighlights = "Poglej poudarke";
$XAddedYRequired = "%d dodano / %d zahtevano";
$RequiredNumberOfItems = "Zahtevano število elementov";
$RequiredNumberOfComments = "Zahtevano število komentarjev";
$UnmarkAsHighlighted = "Odstrani poudarek";
$MarkAsHighlighted = "Označi poudarek";
$UpdatedDateX = "Ažurirano %s";
$UpdatedOnDateXByUserY = "Ažurirano dne %s s strani %s";
$UpdatedDateXByUserY = "Ažurirano %s s strani %s";
$MarkedAsHighlighted = "Označeni kot poudarki";
$UnmarkedAsHighlighted = "Odstranjen poudarek";
$PortfolioAlertNewCommentSubject = "[Portfelj] Nov komentar k objavi %s";
$MakeVisibleForTeachers = "Naredi vidno za učitelje";
$Tag = "Oznaka";
$TagSaved = "Oznaka je bila shranjena";
$TagDeleted = "Oznaka je bila odstranjena";
$CommentByUserXInItemY = "Komentar s strani %s v %s";
$PortfolioPostAddHelp = "Uvod orodja Portfelj";
$LearningPathLTI = "Dostop preko LTI v učno pot";
$UserXNotSubscribedToCourseX = "Uporabnik %s ni bil vpisan v tečaj %s";
$OpenContentInNewTab = "Odpri vsebino v novem zavihku";
$ThereAreUsersOrCoursesUsingThisLanguageYouWantToDisableThisLanguageAndSetUsersAndCoursesWithTheDefaultPortalLanguage = "Obstajajo uporabniki ali tečaji s tem jezikom. Želite onemogočiti ta jezik in nastavite za vse obstoječe uporabnike/tečaje onemogočenega jezika na privzet jezik portala?";
$ReportQuarterlyUsers = "Število uporabnikov registriranih in povezanih";
$NumberOfUsersRegisteredTotal = "Število uporabnikov registriranih (skupaj)";
$NumberOfUsersRegisteredCompared = "Število uporabnikov registriranih(novi : prejšnje četrtletje)";
$NumberOfUsersWhoConnected = "Število uporabnikov povezanih";
$IncompleteDataCurrentQuarter = "*: Tekoče četrletje, nepopolni podatki";
$ReportQuarterlyCourses = "Število obstoječih in dostopnih tečajev";
$NumberOfExistingCoursesTotal = "Število obstoječih tečajev (skupaj)";
$NumberOfAvailableCourses = "Število dostopnih tečajev (brez zaprtih ali skritih, skupaj)";
$ReportQuarterlyHoursOfTraining = "Ur treninga";
$NumberOfHoursTrainingFollowed = "Število ur sledenja treningu (skupno)";
$ReportQuarterlyNumberOfCertificatesGenerated = "Število generiranih potrdil";
$NumberOfCertificatesGeneratedTotal = "Število generiranih potrdil (skupaj)";
$ReportQuarterlySessionsByDuration = "Število sej po trajanju";
$SessionsByDurationByQuarter = "Sej po trajanju (po četrtletju)";
$ListOfCoursesCodes = "Seznam kod tečajev";
$NumberOfSubscribedUsers = "Število vpisanih uporabnikov";
$AllUsersIncludingInactiveIncluded = "*: Vključeni so vsi uporabniki, vključno z neaktivnimi";
$ReportQuarterlyTotalDiskUsage = "Skupna poraba prostora diska";
$ExerciseXNotDeleted = "Test '%s' ni bil odstranjen";
$DoNotIncludeUsers = "Ne vključi uporabnikov";
$ReportDoesNotIncludeListOfUsersNeitherForSessionNorForEachCourse = "Poročilo ne vključuje seznama uporabnikov niti za sejo niti za posamezen tečaj v seji.";
$IncludeExtraFields = "Vključi dodatna polja";
$ImportCourseAgendaReminderTitleDefault = "Vabilo k tečaju ((course_title))";
$ImportCourseAgendaReminderDescriptionDefault = "<p>Ojla ((user_complete_name)).</p>
<p>Obiskovati in opraviti boste morali tečaj ((course_title)) med ((date_start) in ((date_end)). Do tečaja lahko dostopite preko: ((course_link)).</p>
<p>Pozdrav.</p>";
$Scored = "Ocenjeno";
$Edited = "Pregledano";
$Downloaded = "Preneseno";
$YouCanOnlyCopyThisCourseToACourseYouTeach = "Ta tečaj lahko kopirate zgolj v tečaj, v katerem imate vlogo učitelja.";
$RemoveUsers = "Odstrani uporabnike";
$SendFileToOtherUsers = "Pošlji datoteko ostalim uporabnikom";
$RemoveFileFromSelectedUsers = "Odstrani datoteko naslednjim uporabnikom";
$SendOtherUsers = "Pošlji ostalim uporabnikom";
$SendToUsers = "Pošlji uporabnikom";
$FirstLoginForceUsersToChangePassword = "Vsili uporabnikom menjavo gesla po prvi prijavi";
$YourUsernameToAccessIsX = "Pomnite, da je vaše uporabniško ime za dostop %s";
$InstructionsLostPasswordWithLinkX = "Pomnite: Če se ne spomnite gesla, kliknite na <a href=\"%s\">Izgubljeno geslo?</a>, vnesite svoje uporabniško ime in sledite nadaljnim navodilom.";
$RepeatXDays = "Vsakih x dni";
$NumberOfDays = "Število dni";
$WriteAComment = "Podajte komentar";
$ProvideACommentFirst = "Najprej, prosimo, podajte komentar";
$QuizFinalizationDate = "Datum zaključka zadnjega kviza/testa";
$LpFinalizationDate = "Datum zaključka zadnje učne poti";
$ReportByAttempts = "Poročilo po poskusih";
$QuestionsTopic = "Tema vprašanja";
$QuestionsTopicHelp = "Tema vprašanja bo uporabljena kot ime testa in bo poslana AI generatorju za generiranje vprašanj v jeziku nastavljenem za tečaj skupaj z zahtevo, da se ta generirajo v Aiken formatu, ki omogoča enostaven uvoz v tečaj.";
$AIQuestionsGenerator = "AI generator vprašanj";
$AIQuestionsGeneratorNumberHelper = "Večina AI generatorjev omejuje število znakov posredovanih v odgovoru, hkrati pa vaši organizaciji lahko za uporabo izstavijo račun glede na število v odgovoru posredovanih znakov. Uporabljajte torej zmerno; začnite z malimi zahtevki, nato povečujte v skladu s pridobljenimi izkušnjami in zaupanjem. Primerno število vprašanj za prvi test je npr. 3 .";
$ImportSessionAgendaReminderDescriptionDefault = "Živjo ((user_complete_name)). Vabljen si k sodelovanju v seji ((session_name)) v trajanju od ((date_start)) do ((date_end)).";
$ImportSessionAgendaReminderTitleDefault = "Vabilo v sejo ((session_name))";
$MatchingCombination = "Ujemanje s točno izbiro";
$HotSpotCombination = "Slikovno področje s točno izbiro";
$LpAiGenerator = "AI generator učne poti";
$LpAiTopic = "Tema";
$LpAiTopicHelp = "Vtipkajte temo za katero želite, da vam AI pomočnik pomaga zgraditi učno pot. Bolj podrobna je tema, bom točni bodo dobljeni rezultati.";
$LpAiNumberOfItems = "Število elementov učne poti";
$LpAiNumberOfItemsHelper = "Predstavlja število strani, za katere želite, da jih AI pomočnik zgenerira v vašo učno pot. Razdelitev učne poti v več strani, poglavij, sekcij (kakorkoli jih že želite poimenovati) bo v pomoč strukturirnaju tečaja, hkrati pa omogoča lažjo porazdelitev vsebine za boljšo predstavitev.";
$LpAiWordsCount = "Število besed";
$LpAiWordsCountHelper = "Grobo ocenjeno največje število besed (dejansko število elementov), ki jih želite na posamezni strani. Večje število elementov verjetneje generira boljšo vsebino, porabi pa tudi več časa za generacijo in lahko predstavlja večji strošek za vašo organizacijo.";
$OnlySelectedUsersWillSeeTheContent = "Le izbrani uporabniki bodo imeli dostop do vsebine";
$LeaveEmptyToEnableTheContentForEveryone = "Pustite prazno za dostop do vsebine vsem uporabnikom";
$NumberOfQuestionsLimitedFromXToY = "Število vprašanj je omejeno na vrednost med %d in %d.";
$AddTestAfterEachPage = "Dodaj test po vsaki strani";
$HiddenButVisibleForMe = "Skrito, a vidno zame";
$EndOfLearningPath = "Zaključek";
$UnableToDeleteTempFile = "Ne morem dostopati do začasne/temp datoteke";
$DuplicatedUsers = "Podvojeni uporabniki";
$ThisReportOnlyListsUsersThatHaveTheSameFirstnameAndLastname = "To poročilo podaja seznam zgolj uporabnikov z enakimi imeni in priimki";
$ClassNameXDoesntExists = "Ne obstaja razred z imenom \"%s\"";
$NoMoreAccessible = "Ni več na voljo";
$ExportExerciseAllResults = "Izvozi vse rezultate tega testa";
$ExportExerciseNoResult = "V tem testu ni rezultatov za izvoz";
$Exlearner = "Bivši-učeči";
$FileSizeIsTooBig = "Velikost datoteke je prevelika.";
$AnErrorOccured = "Nastopila je napaka";
$EmailPicture = "Slika za zaglavja";
$AddEmailPicture = "DOdaj sliko za zaglavja";
$AddEmailPictureComment = "Ta slika bo uporabljena v zaglavju tečaja, v e-poštnih sporočilih in PDF-jih, zgeneriranih v okviru tega tečaja. Uporabljena slika bo v razmerju 25:7. Ustrezno jo lahko obrežete jo lahko v postopku nalaganja.";
$DeleteEmailPicture = "Odstrani trenutno sliko za zaglavja";
$AddPictureComment = "Končna slika mora imeti razmerje stranic 16:9, obrežete jo lahko tudi po nalaganju.";
$ExportAllExercisesAllResults = "Izvozi vse rezultate vseh testov.";
$ClickToViewDetails = "Kliknite za podrobnosti";
$DateFormatddmmyyyy = "dd.mm.yyyy";
$HideCareersHierarchy = "Skrij hierarhije";
$ShowCareersHierarchy = "Prikaži hierarhije";
$ParentCareer = "Starševska/nadrejena kariera";
$CareerCannotBeDeletedAsItHasChildren = "Ta kariera ne more biti odstranjena dokler niso odstranjeni vsi njeni deli, ali dokler ti niso premaknjeni v drugo kariero.";
$EmailUsedTwiceInImportFile = "Ta e-poštni naslov je že v uporabi v povezavi z drugim uporabnikom v isti datoteki.";
$NotificationInYourForums = "Imate nove objave v naslednjih forumih vaših tečajev.";
$ExtraFieldIdComment = "Ta identifikator je notranji indentifikator v sistemu in ne more vsebovati presledkov ali posebnih znakov. Uporabljan je lahko v povezavi z vtiči sistema, za filtriranje povezanih elementov.";
$IncludeLastLogin = "Vključi zadnjo povezavo";
$DuplicatedUsersByMail = "Podvojeni uporabniki po e-pošti";
$ThisReportOnlyListsUsersThatHaveTheSameEmail = "To poročilo vsebuje zgolj uporabnike z istim e-mail naslovom.";
$CancelNotifyMe = "Prenehaj me obveščati";
$EmptyExpirationDate = "Datum poteka ne more neopredeljen.";
$MailingTestNotSent = "E-poštno sporočilo ni bilo poslano. Razlog je lahko v nestreznem naslovu naslovnika, lahko da je naslovnih neaktiven ali pa je poštni strežnik neustrezno nastavljen (preverite datoetke mail.conf.php).";
$PasswordExpiredPleaseSetNewPassword = "Vaše geslo je poteklo. Prosimo, da nastavite novega pred nadaljevanjem.";
$CopyIframeCodeToIncludeExercise = "Kopiraj iframe kodo spodaj za vključitev vaje :";
$UpdateCourseListXMLCSV = "Ažuriraj seznam tečajev";
$CodeIsRequired = "Koda je zahtevana";
$CourseCodeDoesNotExist = "Ta koda tečaja ne obstaja";
$DuplicateCode = "Podvojena koda";
$CoursesUpdatedSuccessfully = "Tečaji so bili uspešno ažurirani";
$UpdateFailedForCourses = "Ažuriranje ni uspelo za naslednje tečaje";
$QuestionsWithNoAutomaticCorrection = "Vprašanja brez avtomatičnega ocenjevanja";
$UsersReportByCourseInSessions = "Poročilo o napredku uporabnikov po tečajih, v vseh sejah";
$UsersReport = "Poročilo o uporabnikih";
$SelectAllUsers = "Izberi vse uporabnike";
$SelectUsers = "Izberi uporabnike";
$LearningpathName = "Ime učne poti";
$StartingAccessDate = "Datum začetka dostopa";
$EndingAccessDate = "Datum konca dostopa";
?>